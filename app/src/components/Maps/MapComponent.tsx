...
import type { DrillDownLevel } from "../../core/model/location";
import type { FeatureCollection } from "geojson";
import "leaflet.markercluster/dist/MarkerCluster.css";
import "leaflet.markercluster/dist/MarkerCluster.Default.css";
import MarkerClusterGroup from "react-leaflet-markercluster";
import type { MapComponentProps, MarkerClusterType } from "../../core/model/map";
import type {
  CustomFeature,
  CustomFeatureCollection,
  GeoData,
} from "../../core/model/location";
import type { HotspotFeatureGeo } from "../../core/model/hotspot";
...
const MapComponent: React.FC<MapComponentProps> = ({
  ...
  const swrRetryConfig = {
    ...
    onErrorRetry: (error: unknown, key: string, config: unknown, revalidate: Function, { retryCount }: { retryCount: number }) => {
  ...
  useEffect(() => {
    if (!dateCounts[selectedDate] && initialSelectedDate) {
  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        >
          <RefreshCw width="48" height="48" className="text-green-600 mb-4" style={{animation: 'spin 1s linear infinite'}} />
