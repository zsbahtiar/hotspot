...
import type { IChart, QueryData } from "../../core/model/query";
import type { DrillDownLevel, LocationData } from "../../core/model/location";
...
import type { ChartEvent, TooltipItem, ChartOptions, ChartData, InteractionItem } from 'chart.js';
...
import type { TimeFilters } from "../../core/model/time";
...
const MOCK_ALL_LOCATIONS: LocationData[] = [
  { pulau: "Sumatera", provinsi: "Aceh", kab_kota: "Banda Aceh", kecamatan: "", desa: "", lat: 5.5483, lng: 95.3238 },
  { pulau: "Sumatera", provinsi: "Sumatera Utara", kab_kota: "Medan", kecamatan: "", desa: "", lat: 3.5952, lng: 98.6722 },
  { pulau: "Sumatera", provinsi: "Riau", kab_kota: "Pekanbaru", kecamatan: "", desa: "", lat: 0.5071, lng: 101.4478 },
  { pulau: "Jawa", provinsi: "DKI Jakarta", kab_kota: "Jakarta Pusat", kecamatan: "", desa: "", lat: -6.2088, lng: 106.8456 },
  { pulau: "Jawa", provinsi: "Jawa Barat", kab_kota: "Bandung", kecamatan: "", desa: "", lat: -6.9175, lng: 107.6191 },
  { pulau: "Jawa", provinsi: "Jawa Tengah", kab_kota: "Semarang", kecamatan: "", desa: "", lat: -6.9667, lng: 110.4167 },
  { pulau: "Kalimantan", provinsi: "Kalimantan Barat", kab_kota: "Pontianak", kecamatan: "", desa: "", lat: -0.0263, lng: 109.3425 },
  { pulau: "Kalimantan", provinsi: "Kalimantan Tengah", kab_kota: "Palangkaraya", kecamatan: "", desa: "", lat: -2.2090, lng: 113.9213 },
  { pulau: "Kalimantan", provinsi: "Kalimantan Timur", kab_kota: "Balikpapan", kecamatan: "", desa: "", lat: -1.2379, lng: 116.8529 },
  { pulau: "Sulawesi", provinsi: "Sulawesi Utara", kab_kota: "Manado", kecamatan: "", desa: "", lat: 1.4748, lng: 124.8421 },
  { pulau: "Sulawesi", provinsi: "Sulawesi Selatan", kab_kota: "Makassar", kecamatan: "", desa: "", lat: -5.1477, lng: 119.4327 },
  { pulau: "Papua", provinsi: "Papua", kab_kota: "Jayapura", kecamatan: "", desa: "", lat: -2.5920, lng: 140.6682 },
];
